<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-20">CELEBRACIÓN DÍA DEL PADRE</h1>
            <div class=" grid grid-cols-2   text-center">
                <img src="/img/noticias/n5/noticia5.jpg" alt="">
                <img src="/img/noticias/n5/noticia5.1.jpg" alt="">
            </div>
        </div>
    </div>
    {{-- footer --}}

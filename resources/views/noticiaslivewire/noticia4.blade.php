<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-20">CELEBRACIÓN DÍA DEL PADRE EN
                NUESTRO CLUB SOCIAL PDI</h1>

            <div class="md:7/12 lg:w-full text-justify  leading-loose ">

                <iframe width="1500" height="1000" src="https://www.youtube.com/embed/AT3v0ZxJxAU"

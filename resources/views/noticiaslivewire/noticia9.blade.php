<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-20 ">NUEVO CASINO Y WORK CAFE ASEPOL</h1>

            <div class="md:7/12 lg:w-full text-justify  leading-loose ">

                <p class="mt-6 text-gray-600 mb-10">El Nuevo CASINO y WORK CAFÉ ASEPOL, proporciona un servicio de
                    alimentación de primer nivel a todos los alumnos de la Academia Superior, Curso de Alto Mando, de
                    perfeccionamiento y especialidades. Este gran logro es consecuencia de la constante preocupación de
                    nuestro Alto Mando y especialmente de Nuestro Director General, por entregar más y mejores
                    beneficios a nuestro Personal.</p>

                <iframe width="1500" height="1000" src="https://www.youtube.com/embed/fAUowJ8CNgM"

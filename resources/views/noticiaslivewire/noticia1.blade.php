<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-20">EL EXTRAORDINARIO CIRCO DE TARZÁN Y JANE</h1>
            <img src="/img/noticias/n1/noticia1.jpg" alt="">
        </div>
    </div>
     {{-- footer --}}

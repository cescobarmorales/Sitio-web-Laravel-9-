<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-20 uppercase">Eucaristía En Unidades
                De Nuestra PDI</h1>
            <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">

                <div class="md:7/12 lg:w-6/12 text-justify leading-loose">

                    <p class="mt-6 text-gray-600 ">El pasado jueves 9 de junio, nuestro sacerdote Jesús Bonachia, junto al
                        Área social de la Jenabien, visitaron la Brigada Antinarcóticos Metropolitana, donde se celebró
                        una Eucaristía para todo su personal. También se bendijo las diferentes instalaciones de la
                        Briant Metro.
                        Las unidades interesadas en realizar esta ceremonia religiosa en sus unidades, deben solicitarlo
                        al Área Social de Jenabien.
                        Porque tu Bienestar, es nuestro Bienestar</p>
                </div>
                <div class="md:5/12 lg:w-5/12">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/_0UFUugtHow"

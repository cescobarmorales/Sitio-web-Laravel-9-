<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">ÁREA SALUD</h1>
            ...
            <div class="flex flex-row grid grid-cols-4 mb-10 gap-20">
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con1.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con2.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con3.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con4.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
            </div>
            ...
            <div class="flex flex-row grid grid-cols-4 mb-10 gap-20">
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con5.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con6.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con7.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                <div class=" grid grid-cols-4   ">
                    <!-- Card 1 -->
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con8.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
            ...
            <div class="flex flex-row grid grid-cols-4 mb-10 gap-20">
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con9.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con10.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con11.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                <div class=" grid grid-cols-4   ">
                    <!-- Card 1 -->
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con12.png" class="rounded h-64 w-96 " />
                    </a>
                </div>

            </div>

            <div class="flex flex-row grid grid-cols-2 mb-20 gap-20">

                <div class=" grid grid-cols-2  ml-56 ">
                    <!-- Card 1 -->
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con13.png" class="rounded h-64 w-96 " />
                ...
                <div class=" grid grid-cols-2  ml-56 ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/salud/con14.png" class="rounded h-64 w-96 " />
                    </a>
                </div>

<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">ÁREA EDUCACIÓN</h1>
            ...
            <div class="flex flex-row grid grid-cols-4 mb-10 gap-20">
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/educacion/con1.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/educacion/con2.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/educacion/con3.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/educacion/con4.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
            </div>
            <div class="flex flex-row grid grid-cols-4 mb-10 gap-20">
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/educacion/con5.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/educacion/con6.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/educacion/con7.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-4   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/educacion/con8.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
            </div>

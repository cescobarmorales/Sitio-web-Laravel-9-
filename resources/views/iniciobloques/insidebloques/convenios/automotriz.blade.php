<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">ÁREA AUTOMOTRIZ</h1>
            ...
            <div class="flex flex-row grid grid-cols-2 mb-10 gap-20">
                ...
                <div class=" grid grid-cols-2   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/automotriz/con1.png" class="rounded h-64 w-96 " />
                    </a>
                </div>
                ...
                <div class=" grid grid-cols-2   ">
                    ...
                    <a class=" w-96 rounded-xl   " href="">
                        <!-- Image -->
                        <img src="/img/convenios/automotriz/con2.png" class="rounded h-64 w-96 " />
                    </a>
                </div>

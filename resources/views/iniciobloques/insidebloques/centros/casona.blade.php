<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">C.R. LA CASONA</h1>
            ...
            <div class="md:7/12 text-justify  leading-loose mb-20 ">
                        ...
                        <div class="  overflow-x-hidden overflow-y-hidden">
                            <div id="slider"
                                ...
                                <div class="flex flex-shrink-0 relative  ">
                                    <img src="/img/centros/zcentro/casona/casona.jpg" class=" h-96 m-2 " />
                                </div>

                                {{-- 2 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/casona/casona1.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 3 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/casona/casona2.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 4 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/casona/casona3.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 5 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/casona/casona4.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 6 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/casona/casona5.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 7 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/casona/casona6.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 8 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/casona/casona7.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 9 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/casona/casona8.jpg" class="h-96 m-2" />
                                </div>
                ...
                <p class="mt-6 text-gray-600 mb-10" width="1200">Balneario que principalmente ofrece sol, playa y un muy
                    buen ambiente. Ligado a las raíces de la historia de nuestro país, en donde el domingo 26 de
                    noviembre de 1865, la corbeta chilena Esmeralda capturó a la española Covadonga, fundándose Papudo.
                    Cuenta con cuatro habitaciones: 2 pers. / 3 pers. / 4 pers. / 5 pers. y una Cabaña para 6 personas..
                </p>
            ...
            <div class="flex flex-col grid grid-cols-4 mb-10 gap-20">
                ...
                <div class="  text-justify  ">
                    ...
                    <p class="mt-6 text-gray-600 mb-10" width="1200">Cuenta la leyenda que a la llegada del
                        conquistador español Alonso de Quintero en Mayo de 1536, el cacique “Carande” era el dominador
                        de estas tierras y poseedor de una exuberante doble barbilla (papada), que motivó a don Alonso a
                        bautizar el lugar como “Papudo”. Balneario que principalmente ofrece sol, playa y una muy buena
                        urbanización. Los centros urbanos cercanos son: – La Ligua, 23 kilómetros al Noreste – Zapallar,
                        6 kilómetros al Sur – Cachagua, 12 kilómetros al Sur.</p>
                </div>
                ...
                <div class="  text-justify  ">
                    ...
                    <p> + 56 965883114 / 332790688</p>
                    <p>
                        papudocentrosrecreacionales@gmail.com </p>
                    <p>
                        Adm. Sergio Aravena</p>
                    <p>
                        Dirección:
                        Calle Blanco 275, Papudo</p>
                </div>

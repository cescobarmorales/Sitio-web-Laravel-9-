<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">C.R. RUKA WALUNG</h1>
            ...
            <div class="md:7/12 text-justify  leading-loose mb-20 ">
                        ...
                        <div class="  overflow-x-hidden overflow-y-hidden">
                            <div id="slider"
                                ...
                                <div class="flex flex-shrink-0 relative  ">
                                    <img src="/img/centros/zcentro/walung/walung.jpg" class=" h-96 m-2 " />
                                </div>

                                {{-- 2 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/walung/walung1.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 3 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/walung/walung2.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 4 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/walung/walung3.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 5 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/walung/walung4.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 6 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/walung/walung5.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 7 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/walung/walung6.jpg" class="h-96 m-2" />
                                </div>
                ...
                <p class="mt-6 text-gray-600 mb-10" width="1200">Centro Recreacional ubicado en la localidad de Papudo,
                    que cuenta con 4 cabañas para seis personas en una zona que ofrece Sol y principalmente playas
                    tranquilas.</p>
            ...
            <div class="flex flex-col grid grid-cols-4 mb-10 gap-20">
                ...
                <div class="  text-justify  ">
                    ...
                    <p>
                        Dirección: Calle Blanco 220, Papudo</p>
                </div>

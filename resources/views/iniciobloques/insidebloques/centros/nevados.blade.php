<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">C.R. VILLA LOS NEVADOS</h1>
                    ...
                    <div class="  overflow-x-hidden overflow-y-hidden">
                        <div id="slider" class=" flex  items-center justify-start transition ease-out duration-900">
                            ...
                            <div class="flex flex-shrink-0 relative  ">
                                <img src="/img/centros/zsur/nevados/nevados.jpeg" class=" h-96 m-2 " />
                            </div>

                            {{-- 2 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/nevados/nevados1.jpeg" class="h-96 m-2" />
                            </div>

                            {{-- 3 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/nevados/nevados2.jpeg" class="h-96 m-2" />
                            </div>

                            {{-- 4 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/nevados/nevados3.jpeg" class="h-96 m-2" />
                            </div>

                            {{-- 5 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/nevados/nevados4.jpeg" class="h-96 m-2" />
                            </div>

                            {{-- 6 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/nevados/nevados5.jpeg" class="h-96 m-2" />
                            </div>
            ...
            <div class="md:7/12 text-justify  leading-loose mb-20 ">
                ...
                <p class="mt-6 text-gray-600 mb-10" width="1200">Por la “Carretera Austral” antes de cruzar el puente
                    chamiza, nace el camino que lo llevará a la localidad del “Lago Chapo”, de singular atractivo,
                    ubicado entre los cerros Celulies y el Volcán Calbuco y a doscientos cuarenta metros sobre el nivel
                    del mar.</p>
            ...
            <div class="flex flex-col grid grid-cols-4 mb-10 gap-20">
                ...
                <div class="  text-justify  ">
                    ...
                    <p class="mt-6 text-gray-600 mb-10" width="1200">El Lago junto a sus afluentes, permiten disfrutar
                        de la pesca de lanzamiento, trolling y pesca con mosca, mantiene abundancia en truchas arcoíris,
                        farios y salmones coho.</p>
                    <p class="mt-6 text-gray-600 mb-10" width="1200">En sesenta y cinco hectáreas, rodeado de árboles
                        tales como: coigüe, avellanos, maitenes, ulmos y otros se encuentra “Villa Los Nevados”. Entre
                        los centros urbanos cercanos, se encuentran: Petrohué, Puerto Montt, Puerto Varas, Osorno y
                        Puerto Octay.</p>
                </div>
                ...
                <div class="  text-justify  ">
                    ...
                    <p> +569 94508328</p>
                    <p>cv.vineva@investigaciones.cl</p>
                    <p>
                        Adm.  Oscar Ruíz</p>
                    <p>
                        Dirección:Sector Lago Chapo – Puerto Montt</p>
                </div>

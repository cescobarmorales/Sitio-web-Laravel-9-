    ...
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            ...
            <div class="md:7/12 text-justify  leading-loose mb-20 ">
                ...
                <p class="mt-6 text-gray-600 mb-10" width="1200">A sólo 5 minutos de Los Vilos se encuentra la playa
                    cascabeles, pequeña y atractiva ensenada de aguas tranquilas, la cual resulta ser una caleta de
            ...
            <div class="flex flex-col grid grid-cols-4 mb-10 gap-20">
                ...
                <div class="  text-justify  ">
                    ...
                    <p class="mt-6 text-gray-600 mb-10" width="1200">Cascabeles se distingue por ofrecer sus
                        atractivos en un ámbito natural aún no transformado; es un lugar ideal para descansar y
                        recrearse a través de los diversos panoramas que ofrece como: realizar excursiones submarinas,
                        pesca con arpón y disfrutar de hermosos parajes. Destacan las zonas de playas ubicadas a pocos
                        kilómetros del lugar, como: Pichidangui y Los Molles. Para complementar las actividades al aire
                        libre, existe una amplia oferta gastronómica que ofrece Los Vilos (a sólo 10 kilómetros de
                        Cascabeles), alternativa ideal para quienes gustan de pescados como: la albacora, atún, congrio,
                ...
                <div class="  text-justify  ">
                    ...
                    p.duranherrera@gmail.com </p><p>
                        Adm. Pablo Durán Herrera</p>
                    <p>
                        Dirección: Kilómetro 216, Los Vilos. IV Región</p>
                </div>

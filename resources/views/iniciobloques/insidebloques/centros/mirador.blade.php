<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">C.R. EL MIRADOR DEL FRANCÉS</h1>
            ...
            <div class="md:7/12 text-justify  leading-loose mb-20 ">
                        ...
                        <div class="  overflow-x-hidden overflow-y-hidden">
                            <div id="slider"
                                ...
                                <div class="flex flex-shrink-0 relative  ">
                                    <img src="/img/centros/zcentro/miradorfrances/mirador.jpg" class=" h-96 m-2 " />
                                </div>

                                {{-- 2 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/miradorfrances/mirador1.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 3 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/miradorfrances/mirador2.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 4 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/miradorfrances/mirador3.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 5 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/zcentro/miradorfrances/mirador4.jpg" class="h-96 m-2" />
                                </div>
                ...
                <p class="mt-6 text-gray-600 mb-10" width="1200">Centro Recreacional ubicado en la localidad de Papudo,
                    en una zona que ofrece camping, sol y principalmente playas tranquilas.</p>
            ...
            <div class="flex flex-col grid grid-cols-4 mb-10 gap-20">
                ...
                <div class="  text-justify  ">
                    ...
                    <p class="mt-6 text-gray-600 mb-10" width="1200">El centro se ubica a 191 kilómetros de Santiago y a cuatro cuadras de la playa de Papudo, abarcando una superficie de 3,9 hectáreas de bosque de pino ciprés con una espléndida vista, su nombre deriva de los antiguos dueños de estas tierras, de origen francés. 
                        Los centros urbanos más cercanos son: La Ligua, Zapallar y Cachagua.</p>
                </div>
                ...
                <div class="  text-justify  ">
                    ...
                    <p>+ 56 965883114</p>
                    <p>
                        papudocentrosrrecreacionales@gmail.com</p>
                     <p>

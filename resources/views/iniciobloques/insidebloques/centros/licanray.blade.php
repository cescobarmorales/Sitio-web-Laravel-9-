<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">C.R. LICAN RAY</h1>
                    ...
                    <div class="  overflow-x-hidden overflow-y-hidden">
                        <div id="slider" class=" flex  items-center justify-start transition ease-out duration-900">
                            ...
                            <div class="flex flex-shrink-0 relative  ">
                                <img src="/img/centros/zsur/licanray/licanray.jpg" class=" h-96 m-2 " />
                            </div>

                            {{-- 2 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/licanray/licanray1.jpg" class="h-96 m-2" />
                            </div>

                            {{-- 3 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/licanray/licanray2.jpg" class="h-96 m-2" />
                            </div>

                            {{-- 4 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/licanray/licanray3.jpg" class="h-96 m-2" />
                            </div>

                            {{-- 5 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zsur/licanray/licanray4.jpg" class="h-96 m-2" />
                            </div>
            ...
            <div class="md:7/12 text-justify  leading-loose mb-20 ">
                ...
                <p class="mt-6 text-gray-600 mb-10" width="1200">El balneario lacustre de Licán- Ray, que significa
                    “Flor de Piedra”. Posee hermosas vistas de los volcanes Villarrica y Lanin, con bellísimos parajes
                    como La Península, dos extensas playas de aguas cálidas y cristalinas y “El Escorial”, un
                    impresionante río de lava volcánica ubicado a cuatro kilómetros del balneario por el camino hacia
                    Coñaripe, vestigio de la última erupción del volcán Villarrica en 1971..</p>
            ...
            <div class="flex flex-col grid grid-cols-4 mb-10 gap-20">
                ...
                <div class="  text-justify  ">
                    ...
                    <p class="mt-6 text-gray-600 mb-10" width="1200">Ubicado en Casique Cariman #430, a 200 mts del
                        Lago Calafquen y Playa Chica de Lican Ray, con increíbles paisajes y vistas hacia los volcanes,
                        el Centro Recreacional de Lican Ray cuenta con todo lo necesario para disfrutar en familia
                        conectados a la tranquilidad de la naturaleza. .</p>
                    <p class="mt-6 text-gray-600 mb-10" width="1200">Ocho cabañas y quinchos remodelados
                        recientemente, entregan la comodidad y aseguran una estadía cálida y reconfortante.</p>
                </div>
                ...
                <div class="  text-justify  ">
                    ...
                    <p>+ 56 9 91931191</p>
                    <p>mplagges@gmail.com</p>
                     <p>
                        Adm.Manuel Plagges</p>
                    <p>
                        Dirección: Cacique Cariman N°430</p>
                </div>

<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">CLUB DE CAMPO EL DETECTIVE</h1>
                    ...
                    <div class="  overflow-x-hidden overflow-y-hidden">
                        <div id="slider" class=" flex  items-center justify-start transition ease-out duration-900">
                            ...
                            <div class="flex flex-shrink-0 relative  ">
                                <img src="/img/centros/zcentro/clubcampo/campo.jpg" class=" h-96 m-2 " />
                            </div>

                            {{-- 2 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zcentro/clubcampo/campo1.jpg" class="h-96 m-2" />
                            </div>

                            {{-- 3 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zcentro/clubcampo/campo2.jpg" class="h-96 m-2" />
                            </div>

                            {{-- 4 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zcentro/clubcampo/campo3.jpg" class="h-96 m-2" />
                            </div>

                            {{-- 5 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/centros/zcentro/clubcampo/campo4.jpg" class="h-96 m-2" />
                            </div>
            ...
            <div class="md:7/12 text-justify  leading-loose mb-20 ">
                ...
                <p class="mt-6 text-gray-600 mb-10" width="1200">UPara incorporarse en Calidad de Socio del Club de
                    Campo, se deberá requerir mediante una Solicitud Simple dirigida al Jefe Nacional de la Jefatura
                    Nacional de Bienestar y Calidad de Vida, para autorizar el descuento de la cuota de membresía del
                    Club de Campo.</p>

                <p class="mt-6 text-gray-600 mb-10" width="1200">Este recinto cuenta con diferentes instalaciones con
                    una superficie de 4300mts, además ofrece un salón de eventos con capacidad para 200 personas,
                    Piscina con tobogán, zona de quinchos y cuatro cabañas.</p>
            ...
            <div class="flex flex-col grid grid-cols-4 mb-10 gap-20">
                ...
                <div class="  text-justify  ">
                    ...
                    <p class="mt-6 text-gray-600 mb-10" width="1200">Areas verdes, quinchos, salón de eventos, piscina
                        con tobogán, un lugar ideal para disfrutar en familia.</p>
                </div>
                ...
                <div class="  text-justify  ">
                    ...
                    <p> +56984283006</p>
                    <p>clubcampopich@gmail.com</p>
                    <p>
                        Adm. José Lagos Seguel</p>
                    <p>
                        Dirección: Las Tinajas N°4246- La Florida</p>
                </div>

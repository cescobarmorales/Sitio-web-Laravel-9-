<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">C.R. TONGOY</h1>
            ...
            <div class="md:7/12 text-justify  leading-loose mb-20 ">
                        ...
                        <div class="  overflow-x-hidden overflow-y-hidden">
                            <div id="slider"
                                ...
                                <div class="flex flex-shrink-0 relative  ">
                                    <img src="/img/centros/znorte/picstongoy/tongoy1.jpg" class=" h-96 m-2 " />
                                </div>

                                {{-- 2 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/znorte/picstongoy/tongoy2.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 3 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/znorte/picstongoy/tongoy3.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 4 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/znorte/picstongoy/tongoy4.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 5 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/znorte/picstongoy/tongoy5.jpg" class="h-96 m-2" />
                                </div>

                                {{-- 6 --}}
                                <div class="flex flex-shrink-0 relative ">
                                    <img src="/img/centros/znorte/picstongoy/tongoy6.jpg" class="h-96 m-2" />
                                </div>
                ...
                <p class="mt-6 text-gray-600 mb-10" width="1200">Ubicado a sólo 50 kilómetros al sur de La Serena,
                    el
                    balneario de
                    Tongoy impresiona por sus hermosas y extensas playas, principalmente la Playa grande de 14
                    Kilómetros de extensión y la Playa Socos, predilecta de los deportistas náuticos por su suave oleaje
                    e inigualable belleza, las que con sus arenas claras y aguas templadas, constituyen el lugar ideal
                    para un descanso reponedor.</p>
            ...
            <div class="flex flex-col grid grid-cols-4 mb-10 gap-20">
                ...
                <div class="  text-justify  ">
                    ...
                    <p class="mt-6 text-gray-600 mb-10" width="1200">Ubicado a sólo 50 kilómetros al sur de La
                        Serena,
                        el balneario de Tongoy impresiona por sus hermosas y extensas playas, principalmente la Playa
                        grande de 14 Kilómetros de extensión y la Playa Socos, predilecta de los deportistas náuticos
                        por su suave oleaje e inigualable belleza, las que con sus arenas claras y aguas templadas,
                        constituyen el lugar ideal para un descanso reponedor.</p>
                </div>
                ...
                <div class="  text-justify  ">
                    ...
                    <p>
                        51 239 1108</p>
                    sertongy@gmail.com <p>
                        Adm. Edna Hernández Roldan</p>
                    <p>
                        Dirección: Guayacán Nº 104, Tongoy Alto</p>
                </div>

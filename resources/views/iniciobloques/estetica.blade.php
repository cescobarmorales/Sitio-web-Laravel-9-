<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">CENTRO DE ESTETICA POLICIAL</h1>


            <div class=" container border-b border-gray-900 mb-10 mt-10"></div>
            <div class="grid grid-cols-2 col-span-2   gap-1  ">
                <h1 class="text-2xl text-gray-900 font-bold md:text-4xl  ">Los mejores servicios para nuestros socios
                </h1>
            </div>
            ...
            <div class="2xl:mx-auto 2xl:container mx-4 py-16">
                ...
                <div class="w-full relative flex items-center justify-center">
                    <img src="/img/estetica/estetica.jpg" alt="dining"
                    ...
                    <div
                        ...
                        <div class="flex flex-row grid grid-cols-2 mb-10 gap-20">
                            ...
                            <div class=" grid grid-cols-2  mb-10 text-center">
                                <a class=" bg-[#0369a1] text-white rounded w-96 h-10 p-3" href="{{ route('estetica.precios') }}">
                                    LISTADO DE PRECIOS
                                </a>
                            </div>
                            <div class=" grid grid-cols-2  mb-10 text-center">
                                <a class=" bg-[#0369a1] text-white rounded w-96 h-16 p-3" href="">
                                    AGENDA TÚ ATENCIÓN
                                </a>
                            </div>
                        </div>
            ...
            <div class="2xl:mx-auto 2xl:container mx-4 py-16">
                ...
                <div class="w-full relative flex items-center justify-center">
                    ...
                    <div
                        ...
                        <div class="flex flex-row grid grid-cols-2 mt-10 mb-10 gap-20">

                            <div class=" grid grid-cols-2  mb-10 text-center">
                                <img src="/img/estetica/estetica1.jpg" class="rounded ml-64 h-full " />
                            </div>
                            <div class=" grid grid-cols-2  mb-10 text-center">
                                <img src="/img/estetica/estetica2.jpg" class="rounded h-full" />
                            </div>
                        </div>
                    ...
                    <div class="  overflow-x-hidden overflow-y-hidden">
                        <div id="slider" class=" flex  items-center justify-start transition ease-out duration-700">
                            ...
                            <div class="flex flex-shrink-0 relative  ">
                                <img src="/img/estetica/slider/slider1.jpg" class=" h-40 m-2 " />
                            </div>

                            {{-- 2 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/estetica/slider/slider2.jpg" class="h-40 m-2" />
                            </div>

                            {{-- 3 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/estetica/slider/slider3.jpg" class="h-40 m-2" />
                            </div>

                            {{-- 4 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/estetica/slider/slider4.jpg" class="h-40 m-2" />
                            </div>

                            {{-- 5 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/estetica/slider/slider5.jpg" class="h-40 m-2" />
                            </div>

                            {{-- 6 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/estetica/slider/slider6.jpg" class="h-40 m-2" />
                            </div>

                            {{-- 7 --}}
                            <div class="flex flex-shrink-0 relative ">
                                <img src="/img/estetica/slider/slider7.jpg" class="h-40 m-2" />
                            </div>
            ...
            <div class=" container border-b border-gray-900 mb-10 mt-10"></div>
            <h1 class="text-2xl text-gray-900  font-bold md:text-4xl mb-10">Todo pensado para ti . . .</h1>

            <div class="flex flex-row grid grid-cols-3 mb-10 gap-20">

                <div class=" grid grid-cols-3   ">
                    <!-- Card 1 -->
                    <a class=" w-64 rounded-xl   " href="">
                        <iframe class="rounded-xl" width="400" height="315"
                            src="https://www.youtube.com/embed/P9CvG4keDxY" title="YouTube video player" frameborder="0"
                ...
                <div class=" grid grid-cols-3   ">
                    ...
                    <a class=" w-64 rounded-xl   " href="">
                        <iframe class="rounded-xl" width="400" height="315"
                            src="https://www.youtube.com/embed/b9yQlFr6pP8" title="YouTube video player"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    </a>
                ...
                <div class=" grid grid-cols-3   ">
                    ...
                    <a class=" w-64 rounded-xl   " href="">
                        <iframe class="rounded-xl" width="400" height="315"
                            src="https://www.youtube.com/embed/lHAEziudHIY" title="YouTube video player"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    </a>

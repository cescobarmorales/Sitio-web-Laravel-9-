<x-app-layout>
    <div class="py-16 bg-white">
        <div class="container m-auto  text-gray-600 bg-white ">
            <h1 class="text-2xl text-gray-900 text-center font-bold md:text-4xl mb-10">CUIDAMOS TU BIENESTAR</h1>
             ...
             <div class="2xl:mx-auto 2xl:container mx-4 py-16">
                 ...
                 <div class="w-full relative flex items-center justify-center">
                     <img src="/img/farmacia/farmacia.jpg" alt="dining"
                     ...
                     <div
                         ...
                         <div class="flex flex-row grid grid-cols-3 mb-10 gap-20">
                             ...
                             <div class=" grid grid-cols-3  mb-10 text-center">
                                 <a class=" bg-[#0369a1] text-white rounded w-96 h-10 p-3" href="https://www.jenabien.cl/?p=7181">
                                     SUCURSALES
                                 </a>
                             </div>
                             <div class=" grid grid-cols-3  mb-10 text-center">
                             ...
                             <div class=" grid grid-cols-3  mb-10 text-center">
                                 <a class=" bg-[#0369a1] text-white rounded w-96 h-10 p-3" href="http://jenabien.cl/consmed/buscador_farmacia.php">
             ...
             <h2 class="text-2xl text-gray-900 font-bold text-center md:text-4xl">OFERTAS JUNIO</h2>
                    ...
                    <div
                        ...
                        <div class="flex flex-row grid grid-cols-2 mt-10 mb-10 gap-20">
                            ...
                            <div class=" grid grid-cols-2  mb-10 text-center">
                                <img src="/img/farmacia/fa1.jpg" class="rounded ml-64 h-full " />
                            </div>
                            <div class=" grid grid-cols-2  mb-10 text-center">
                                <img src="/img/farmacia/fa2.jpg" class="rounded h-full" />
                            </div>
                        </div>
            ...
            <div class="flex flex-row grid grid-cols-2 mb-10 gap-20">
                ...
                <div class=" grid grid-cols-2  mb-10 text-center">
                    <a class=" bg-[#0369a1] text-white rounded w-96 h-10 p-3 uppercase" href="">
                        Farmacia Requisitos De Compra
                    </a>
                </div>
                <div class=" grid grid-cols-2  mb-10 text-center">
                    <a class=" bg-[#0369a1] text-white rounded w-96 h-10 p-3 uppercase" href="http://jenabien.cl/consmed/buscador_farmacia.php">
                        Buscador De Medicamentos
                    </a>
                </div>
            </div>
                    ...
                    <div class="  overflow-x-hidden overflow-y-hidden">
                        <div id="slider"
                            ...
                            <div class="flex flex-shrink-0 relative  ">
                                <img src="/img/farmacia/farmacia.jpg" class=" h-64 m-2 " />
                            </div>
